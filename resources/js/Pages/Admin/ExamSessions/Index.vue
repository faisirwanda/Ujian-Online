            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-3 col-12 mb-2">
                        <Link href="/admin/exam_sessions/create" class="btn btn-md btn-primary border-0 shadow w-100"
                                ...
                                <tbody>
                                    <tr v-for="(exam_session, index) in exam_sessions.data" :key="index">
                                        ...
                                        <td>
                                            ...
                                            <ul class="mt-2">
                                                <li>Kelas : <strong class="fw-bold">{{ exam_session.exam.classroom.title
                                                        }}</strong></li>
                                                <li>Pelajaran : <strong class="fw-bold">{{
                                                        exam_session.exam.lesson.title }}</strong></li>
                                            </ul>
                                        </td>
